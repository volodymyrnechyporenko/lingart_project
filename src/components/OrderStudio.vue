    ...
    <div class="order-studio">
        ...
        <div class="order-wrap">
            <div class="order-studio-info">
                <p>Ви можете орендувати наше устаткування в будь-який зручний для вас час.</p>
            </div>
            <div class="order-studio-btn">
                <button class="order_btn" @click="showDates = !showDates">Дивитись дати</button>
...
.order-studio-btn, #calendar-wrap {
    display: flex;
    flex-direction: column;
    gap: 1rem;
    width: 60%;
